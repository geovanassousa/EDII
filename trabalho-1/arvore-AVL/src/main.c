            ...
            if (novaStream == NULL) {
                ...
                if (str_cmp_i(aprSel->streamAtual, novaStream->nome) == 0) {
                    ...
                    if (qtdProg > 0) {
                        ...
                        char dataAtual[11];
                        strcpy(dataAtual, "16/09/2025"); /* data exemplo*/
